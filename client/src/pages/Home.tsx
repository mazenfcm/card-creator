  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* ── Left: Controls Panel ── */}
        <div className="w-full lg:w-[42%] xl:w-[38%] border-r border-border overflow-y-auto">
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center bg-background relative overflow-hidden">
          ...
          <div className="relative flex flex-col items-center gap-6 p-8">
            ...
            <div className="flex items-center gap-6 text-center">
              <div>
                <p className="font-display text-2xl font-black text-purple-400">{cardData.ovr || "—"}</p>
                <p className="text-[10px] text-muted-foreground tracking-wider">OVR</p>
              </div>
              <div className="w-px h-8 bg-border" />
              <div>
                <p className="font-display text-lg font-bold text-foreground">{cardData.position || "—"}</p>
                <p className="text-[10px] text-muted-foreground tracking-wider">POS</p>
              </div>
              <div className="w-px h-8 bg-border" />
              <div>
                <p className="font-display text-sm font-bold text-foreground truncate max-w-[100px]">{cardData.name || "—"}</p>
            ...
            <motion.button
              type="button"
              onClick={() => setDownloadOpen(true)}
              className="btn-glow flex items-center gap-2 px-5 py-2.5 rounded-xl bg-purple-700/20 border border-purple-500/30 text-purple-300 text-sm font-display font-bold hover:bg-purple-700/30 transition-colors"
              whileTap={{ scale: 0.97 }}
            >
              <Download size={14} />
              Download Card
        ...
        <div className="lg:hidden fixed bottom-0 inset-x-0 z-20 border-t border-border bg-background/95 backdrop-blur-sm px-4 py-3 flex items-center gap-3">
